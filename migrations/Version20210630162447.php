 ...
 */
final class Version20210630162447 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE page DROP type, CHANGE parent_id menu_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE page ADD type SMALLINT NOT NULL, CHANGE menu_id parent_id INT DEFAULT NULL');
